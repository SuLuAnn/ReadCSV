            ...
            for (int i = 1; i <= page; i++)
            {
                ...
                foreach (Match detail in stockVoteDatas)
                {
                    voteDay.Add(new XElement(GlobalConst.XML_NODE_NAME,
                        ...
                        GlobalFunction.ChangeNull(GlobalConst.CHINESS_MEETING_DATE, ChangeYear(detail.Groups[GlobalConst.MEETING_DATE].Value.Replace(GlobalConst.SLASH, string.Empty))),
